  ...
  return (
    <>
      ...
      <div className="project-list">
        <h3>
          <a href="https://github.com/Bahalul1981/My-web-site.git">Web Shop</a>
        </h3>
        <p>
          ...
          applikation har jag använt mig av HTML, CSS, React, JavaScript, Redux
          Toolkit och en del Node.js.
        </p>
      </div>
      <div className="project-list">
        <h3>
        ...
        <p>
          Detta är min personliga webbplats. För att bygga denna applikation har
          jag använt mig av HTML, SCSS, React och JavaScript.
        </p>
      </div>
      <div className="project-list">
        <h3>
      ...
      <div className="project-list">
        <h3>
          <a href="https://github.com/Bahalul1981/ArvidHotel.git">Hotell App</a>
        </h3>
      </div>
      <p>
